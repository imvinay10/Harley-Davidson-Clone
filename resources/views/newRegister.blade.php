    ...
    <div class="container-fluid" style="width: 100%; " id="service-1">
        ...
        <div class="row featurette "  id="service-1">
            ...
            <div class="col-md-7">
                ...
                <form method="POST" action="{{ route('register') }}" class="text-right" style="width: 350px;">
                        @csrf
                    ...
                    <div class="form-group text-left " >
                        ...
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                                ...
                                @enderror <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                    </div>
                    <div class="form-group  text-left ">
